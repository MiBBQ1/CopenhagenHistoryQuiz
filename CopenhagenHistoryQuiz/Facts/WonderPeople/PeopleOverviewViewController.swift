...
final class PeopleOverviewViewController: UIViewController {
    ...
    init(model: WonderPeople) {
        self.imageView.image = model.image
        self.titleLabel.text = model.name
        self.descriptionLabel.attributedText = dataStr.shared.createData()[model.name]
...
extension PeopleOverviewViewController: UIScrollViewDelegate {
