...
final class WonderPeopleMoreViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setBackImage()
        guidesTableView.register(PeopleTableViewCell.self, forCellReuseIdentifier: "ArticlesTableViewCell")
...
extension WonderPeopleMoreViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return dataStr.wonderPeopleList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "ArticlesTableViewCell", for: indexPath) as? PeopleTableViewCell else {
            return UITableViewCell()
        }
        cell.selectionStyle = .none
        cell.configureWith(model: dataStr.wonderPeopleList[indexPath.row])
        return cell
    }
