...
final class WonderGameScene: SKScene {
    var currentLevel = 1
    var currentQuestion = 0
    var lives = 3
    let maxLives = 3
    var numberOfQuestions = 5
    var questions: [CityHistory] = []
    ...
    func setupQuestions() {
        questions = dataStr.cityHistoryList
    }
    ...
    func showNextQuestion() {
        ...
        questionLabel.text = "Image pertains to \(question.eventName)"
    ...
    func showPortraits(for question: CityHistory) {
        ...
        if !selectedPeople.contains(where: { $0.eventName == question.eventName }) {
    ...
    func showDetails(for question: CityHistory) {
        ...
        state = 1
        questionLabel.text = "Where it was?"
        ...
        if !options.contains(where: { $0.yearEvent == question.yearEvent }) {
    ...
    func checkAnswer(_ node: CGPoint, for question: CityHistory) {
        if state == 0 {
